...
import { resolveMediaSrc } from '../../utils/mediaResolver';
...
export const ScrapbookPlaceholder: React.FC<ScrapbookPlaceholderProps> = ({
  ...
  // Resolve media via shared mediaResolver
  const { resolvedImage, resolvedVideo } = resolveMediaSrc(tag, imgSrc, videoSrc);

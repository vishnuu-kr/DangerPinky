...
import { Play, Flame, FolderOpen, ShieldCheck, Sparkles, Video, Crown, Heart, ArrowRight, BookOpen, X } from 'lucide-react';
    ...
    <div className="relative min-h-[92vh] flex flex-col items-center justify-center px-4 py-8 text-center max-w-5xl mx-auto select-none">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 w-full max-w-2xl mb-10">
        ...
        <button
          ...
          className="btn-candy-pill px-4 py-2 rounded-full text-xs font-semibold text-rose-300 hover:text-white flex items-center gap-2 cursor-pointer border-rose-500/40"
        >
      ...
      {isVideoModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn">
          <div className="relative w-full max-w-4xl bg-slate-900 border-2 border-pink-500/50 rounded-2xl shadow-2xl overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3 bg-slate-950/80 border-b border-pink-500/30">
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-rose-500 inline-block animate-pulse" />
                <span className="font-game font-bold text-sm text-pink-300">DangerPinky — Official Demo Showcase</span>
              </div>
              <button
                type="button"
            ...
            <div className="relative w-full aspect-video bg-black flex items-center justify-center">
              <iframe
                ...
                title="DangerPinky Official Demo Video"
